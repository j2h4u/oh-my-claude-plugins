...
**End-of-session CI check:** After the final push, verify CI status with `gh run list --limit 1`. If the latest run failed, investigate and fix before signing off.
